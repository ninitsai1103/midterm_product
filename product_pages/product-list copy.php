...
<body class="g-sidenav-show   bg-gray-100">
                    ...
                    <div class="col-12">
                        <div class="card mb-4">
                            <div class="card-header pb-0">
                                ...
                                <form action="">
                                    <div class="d-flex">
                                        <select class="form-select form-select-lg mb-3 me-2" aria-label="Large select example" name="primaryCategorySearch" id="setPrimaryCategory">
                                        ...
                                        <select class="form-select form-select-lg mb-3 me-2" aria-label="Large select example" name="secondaryCategorySearch" id="setSecondaryCategory">
    ...
    <script>
        ...
        <!-- 下拉式選單連動 -->
        <script>
            const setPrimaryCategory = document.getElementById("setPrimaryCategory");
            const setSecondaryCategory = document.getElementById("setSecondaryCategory");
            
            if (setPrimaryCategory === "") {
                return;
            }

            setPrimaryCategory.addEventListener("change", function() {
                let primaryCategoryName = this.value;
                setSecondaryCategory.innerHTML = `<option selected>次類別</option>`;


                $.ajax({
                        method: "POST",
                        url: "setSecondaryCategory.php",
                        dataType: "json",
                        data: {
